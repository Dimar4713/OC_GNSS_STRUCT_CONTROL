...
from constellation_control.preview.glonass_almanac_input import (
    ...
    install_glonass_almanac_routes,
)
...
function syncScenarioEditor(){
  ...
  if(typeof syncGlonassAuthoritySatellites==='function')syncGlonassAuthoritySatellites();
...
def render_preview_page_for_test() -> str:
    ...
    page = page.replace(
        "</section></main>",
        f"{DRIFT_CONSISTENCY_CARD}{RUN_PROMOTION_CARD}{RESOURCE_STATE_CARD}{SPACECRAFT_CATALOG_CARD}{CONSTELLATION_EDITOR_CARD}{PERTURBATION_CARD}{GALILEO_GSC_CARD}{IAC_GNSS_CARD}{GLONASS_ALMANAC_CARD}{GNSS_ALMANAC_CARD}{NORAD_CARD}{OSCULATING_CARD}{WALKER_CARD}{WORKBOOK_CARD}{_EDITOR_CARD}</section></main>",
        1,
    )
    page = page.replace(
